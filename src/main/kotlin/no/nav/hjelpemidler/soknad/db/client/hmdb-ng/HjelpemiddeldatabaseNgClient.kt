package no.nav.hjelpemidler.soknad.db.client.`hmdb-ng`
...
import java.net.URL
import no.nav.hjelpemidler.soknad.db.client.`hmdb-ng`.hentproduktermedhmsnrs.Product as HentproduktermedhmsnrsProdukt
import no.nav.hjelpemidler.soknad.db.client.`hmdb-ng`.hentrammeavtaleidogleverandoridforprodukter.Product as HentrammeavtaleidogleverandoridforprodukterProdukt

object HjelpemiddeldatabaseNgClient {
    private val logg = KotlinLogging.logger {}
    private val client =
        GraphQLKtorClient(
            url = URL("${Configuration.application.grunndataApiNgURL}/graphql"),
