...
fun lagSakstilknytningInfotrygd(fnrBruker: String = lagFødselsnummer()): Sakstilknytning.Infotrygd =
    Sakstilknytning.Infotrygd(
...
fun lagSakstilknytningHotsak(): Sakstilknytning.Hotsak =
